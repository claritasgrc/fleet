...
// Testing API with simple input output request response.
func (svc service) PrintInputString(ctx context.Context, name string, text string) (string, error) {
	output := "Hello " + name + "! Echo: " + text
	return output, nil
}
